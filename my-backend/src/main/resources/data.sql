...
(105, 3, 3, 1, 1, 0, '2025-09-29 00:00:00', '2025-09-30 00:00:00', 'COMPLETED', '2025-08-15 14:00:00');
...
-- 리뷰 데이터 
INSERT INTO review (reservation_id, user_id, hotel_id, rating, content, created_at, status) VALUES
(301, 2, 1, 5, '가족과 함께한 완벽한 휴가였습니다. 객실에서 보이는 바다 전망이 환상적이었고, 직원분들 모두 친절하셔서 기분 좋게 머물다 갑니다. 수영장 시설도 최고!', '2025-08-04 11:20:11', 'VISIBLE'),
(302, 3, 1, 4, '전반적으로 만족스러운 숙박이었습니다. 룸서비스 음식 맛이 훌륭했고, 침구가 편안해서 좋았어요. 다만, 주말이라 그런지 주차 공간이 조금 부족했던 점이 아쉬웠습니다.', '2025-08-09 18:45:23', 'VISIBLE'),
(303, 4, 2, 5, '부산 최고의 호캉스 명소! 해운대 바로 앞이라 위치도 좋고, 부대시설이 잘 되어 있어서 호텔 안에서만 있어도 즐거웠어요. 다음에 또 방문할 의사 100%입니다.', '2025-08-18 09:30:00', 'VISIBLE'),
(101, 2, 1, 3, '기대했던 것보다는 평범했습니다. 위치나 시설은 괜찮았지만, 가격 대비 특별한 점은 잘 모르겠어요. 조식이 조금 더 다양했으면 좋겠습니다.', '2025-09-08 20:10:05', 'VISIBLE'),
(102, 3, 1, 5, '기념일 여행으로 방문했는데, 호텔 측의 세심한 배려에 감동했습니다. 객실도 업그레이드해주시고, 웰컴 드링크도 정말 좋았어요. 잊지 못할 추억을 만들고 갑니다.', '2025-09-15 14:00:15', 'VISIBLE'),
(103, 4, 1, 4, '친구들과의 여행에 이만한 곳이 없네요. 헬스장도 넓고 기구가 다양해서 좋았고, 저녁에는 바에서 칵테일 한잔하며 즐거운 시간을 보냈습니다.', '2025-09-17 12:12:12', 'VISIBLE'),
(105, 3, 2, 4, '출장 때문에 급하게 예약했는데 만족스럽습니다. 비즈니스 센터 이용이 편리했고, 와이파이 속도도 빨라서 업무 보기에 불편함이 없었습니다.', '2025-10-01 08:55:01', 'VISIBLE'),
(106, 4, 2, 2, '반려동물 동반이 가능해서 선택했는데, 추가 요금에 비해 시설이 너무 미흡합니다. 전용 공간도 거의 없고, 객실 내 냄새도 심했어요. 개선이 필요해 보입니다.', '2025-10-04 16:21:43', 'VISIBLE'),
(107, 2, 1, 5, '역시 씨마크! 이름값하는 호텔입니다. 모든 것이 완벽했고, 특히 인피니티풀은 인생샷 명소네요. 강력 추천합니다.', '2025-10-06 13:04:18', 'VISIBLE'),
(108, 3, 1, 4, '디럭스룸이었는데, 생각보다 방이 넓고 쾌적했습니다. 청소 상태도 매우 깔끔했고요. 재방문 의사 있습니다.', '2025-10-07 21:08:33', 'VISIBLE');
